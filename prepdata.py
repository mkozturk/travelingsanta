#!/usr/bin/env python
# Generates C source files santa.h and data.c from the original data.
# data.c stores: The (ordered) list of prime city IDs
import numpy as np
...
primeids = primes(len(cities)+1) # list of prime city ids.
